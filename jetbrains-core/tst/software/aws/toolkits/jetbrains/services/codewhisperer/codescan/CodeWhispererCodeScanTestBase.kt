...
open class CodeWhispererCodeScanTestBase(projectRule: CodeInsightTestFixtureRule) {
    ...
    """
    internal fun getSourceFilesUnderProjectRoot(sessionConfigSpy: CodeScanSessionConfig, testFile: VirtualFile, size: Int) {
        assertThat(sessionConfigSpy.getSourceFilesUnderProjectRoot(testFile).size).isEqualTo(size)
    }
    internal fun getTotalProjectSizeInBytes(sessionConfigSpy: CodeScanSessionConfig, totalSize: Long) {
        runBlocking {
